...
const railData = JSON.parse(getData('/src/Colette/crude_by_rail/crude_by_rail_wcs.json'));
...
const seriesData = railChartTypes(prepareSeriesNonTidy(railData,railFilters,['Crude by Rail','WCS-WTI Differential'],'Date',railColors))
